        ...
        repack_transform = _transforms.Group(
            inputs=[
                _transforms.RepackTransform({
                    ...
                    "observation/wrist_image": "observation.images.left_wrist",
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotHFMDataConfig(
            ...
            assets=AssetsConfig(asset_id="G1WholebodyLocomotionPickBetweenTablesTeleop-v0"),
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
    ...
    TrainConfig(
        name="G1WholebodyBendPickTeleop-v0",
        project_name="phi0",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotHFMDataConfig(
            repo_id=f"{os.environ['PSI_HOME']}/data/simple/G1WholebodyBendPickTeleop-v0",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "G1WholebodyBendPickTeleop-v0"},
        checkpoint_base_dir=f".runs/openpi-05",
    ),
    TrainConfig(
        name="pick_tissue_sonic_unified",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotHFMDataConfig(
            repo_id="/mnt/data2/wpy/workspace/Isaac-GR00T/data/pick_tissue_sonic_unified",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "pick_tissue_sonic_unified"},
