...
if __name__ == "__main__":
    ...
    import os
    # os.environ["TORCHINDUCTOR_DISABLE_CUTLASS"] = "1"
    # os.environ["TRITON_AUTOTUNE_CACHE_DIR"] = "disable"
    os.environ["OPENPI_DATA_HOME"] = f"{os.getcwd()}/.cache/openpi" #"/app/.cache/openpi"
