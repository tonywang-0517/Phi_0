...
export PHI0_PY="${PHI0_PY:-/home/user/anaconda3/envs/Phi-0-wpy/bin/python}"
export GR00T_ROOT="${GR00T_ROOT:-${HOME}/YZY/GR00T-WholeBodyControl}"
export PYTHONPATH="${PHI0_ROOT}/src:${PHI0_WORKSPACE}/FastWAM/src:${PYTHONPATH:-}"
export TensorRT_ROOT="${TensorRT_ROOT:-${PHI0_WORKSPACE}/deps/TensorRT-10.13.3.9}"
