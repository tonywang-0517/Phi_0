#!/usr/bin/env bash
# Ablation D: VLM + ACT head 12 layers (2x blocks), mono camera, 4-GPU DDP, 35k steps.
set -euo pipefail
...
EXP="${EXP:-experiments/libero_spatial_vlm_act12_35k_ddp4}"
CONFIG="${CONFIG:-train_libero_spatial_vlm_act12_35k_ddp4}"
CKPT_NAME="${CKPT_NAME:-libero_spatial_vlm_act12_35k_ddp4}"
BATCH_SIZE="${BATCH_SIZE:-16}"
LR_ACTION="${LR_ACTION:-5e-5}"
...
echo "==> VLM+ACT12 (2x blocks) 35k DDP: ${NGPUS} GPUs (${CUDA_DEVICES})"
